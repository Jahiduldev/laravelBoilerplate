...
class UserController extends Controller
{
    ...
    public function create(CategoryRequest $request)
    {
        ...
        $userAttributes = (new CategoryAttributes());
        $data = $userAttributes->updateDataRequest((new Category())->getFillable(), $request)->toArray();

        $response = $this->service->create($data);

        if ($response) {
            return redirect()->route('user-view')->with('success', 'Category added successfully.');
        }
    ...
    public function update(UpdateCategoryRequest $request)
    {
        ...
        if ($response) {
            return redirect()->route('user-view')->with('success', 'Occupation update successfully.');
        }
