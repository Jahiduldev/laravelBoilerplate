...
$(function() {
                ...
                { data: 'status' },
                {
                    ...
                    render: function(data, type, full, meta) {
                        return (
                            ...
                            '</ul>' +
                            '</div>' +
                            '<a href="/admin/{{ name }}/edit/' + data + '" class="btn btn-sm btn-icon item-edit"><i class="text-primary ti ti-pencil"></i></a>'
                        );
                    }
                }
            ],
    ...
    function deleteDataWithId(id) {
        ...
        $.ajax({
            url: '/admin/{{ name }}/delete', // Update this with your actual delete route
            type: 'DELETE',
            headers: {
