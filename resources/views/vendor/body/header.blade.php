<header>
    <div class="topbar d-flex align-items-center">
        <nav class="navbar navbar-expand">
                                ...
                                <a class="dropdown-item" href="javascript:;">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            <h6 class="msg-name">Message <span class="msg-time float-end"></span></h6>
                                            <p class="msg-info">test</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
            ...
            @php
                $vendorData = App\Models\User::find(Auth::user()->id);
            @endphp
            <div class="user-box dropdown">
                <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#"
                    role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="{{ !empty($vendorData->photo) ? url('upload/vendor_images/' . $vendorData->photo) : asset('upload/no_image.jpg') }}"
